...
<div class="table-responsive activity-table">
    <table class="table table-striped table-condensed table-sm @if (config('LaravelLogger.enableDrillDown') && $hoverable)  @endif data-table">
        <thead>
            <tr>
                <th>
            ...
            @foreach ($activities as $activity)
                <tr
                    ...
                    <td style="word-wrap: break-word; max-width: 300px;">
                        ...
                        @else
                            <a href="{{ $activity->route }}" title="{{ $activity->route }}">
                                {{ $activity->route }}
                            </a>
                        @endif
                    </td>
